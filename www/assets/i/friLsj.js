...
function ambil_data_penjualan(tgl){
    ...
    getX({m:"pengelola-pesanan-list",id_pengelola:getLS("id_pengelola"), tanggal:tgl},function(res){
...
function html_data_penjualan_(id, nama, total_harga, span_data){
    ...
    '    <div class="padding row"> '+
    '        <div class="col" style="width:55px;padding-top:5px;padding-left:1px"><i class="la la-user la-fw xxlarge"></i></div> '+
    '        <!-- <div class="ripple- text-blue col right this-icon" onclick="u_penj(this)"><i class="la la-search la-fw xxlarge"></i>'+span_data+'</div>--> '+
